        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div class="md:col-span-2 lg:col-span-1" >
                <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        <h5 class="text-xl text-gray-600 text-center">Recovery</h5>
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-3xl font-bold text-gray-700">2,988</h3>
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                        ...
                        <span class="block text-center text-gray-500">Compared to last week 1,988</span>
                    </div>
                    <table class="w-full text-gray-600">
                        <tbody>
                            <tr>
                                <td class="py-2">Radiology</td>
            ...
            <div>
                <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                    <h5 class="text-xl text-gray-700">Repeat Patients</h5>
                    <div class="my-8">
                        <h1 class="text-5xl font-bold text-gray-800">64,5%</h1>
                        <span class="text-gray-500">Compared to last week 1,988</span>
                    </div>
            ...
            <div>
                <div class="lg:h-full py-8 px-6 text-gray-600 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div class="mt-6">
                        <h5 class="text-xl text-gray-700 text-center">Postive Feedback</h5>
                        <div class="mt-2 flex justify-center gap-4">
