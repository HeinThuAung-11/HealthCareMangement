...
export const LabTestDetail = () => {
    ...
    data = data.filter(ele => ele._id.$oid === labTestId)[0]
    const handleClick = () => {
            ...
            {data && <>
                ...
                <div className={"col-span-7 ml-10 flex flex-col gap-y-3"}>
                    <div className={"flex flex-col gap-y-3"}>
                        ...
                        <h2 className={"text-lg font-semibold"}>{data.description}
                        </h2>
                    ...
                    <div>
                        ...
                        <div className={"flex mb-5"}>
                            ...
                            <div className={"flex flex-col ml-5"}>
                                ...
                                <p className={"text-md font-medium"}>A certified professional will collect your sample
                                    from
                                    your
                                    preferred
                                    location</p>
