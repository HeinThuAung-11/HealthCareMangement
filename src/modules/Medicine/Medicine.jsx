            ...
            <div class=" flex items-center justify-center px-5 py-5 mt-40 mb-24">
                <div class=" flex items-center justify-center px-5 py-5">
                    <div class="w-full">
                        ...
                        <p class="text-bl text-gray-600 text-center px-5">"Exceptional experience with PocketDoc. The
                            dedicated staff provided compassionate care, ensuring my comfort and recovery.
                            State-of-the-art facilities and prompt services exceeded expectations. Grateful for the
                            skilled medical team and a warm, supportive environment. Highly recommend for outstanding
