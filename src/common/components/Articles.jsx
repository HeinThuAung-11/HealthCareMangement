...
export const Articles = () => {
    ...
    return (
        ...
        <div class="bg-blue-50 p-4">
            <h1 class="text-2xl font-semibold text-center mb-4">Latest Articles</h1>
                <div class="flex flex-wrap mb-2">
                    <div class="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pr-2">
                        <div>
                            <img alt="person capturing an image" src="https://cdn.tuk.dev/assets/templates/classified/Bitmap (1).png" tabindex="0" class="focus:outline-none w-full h-66" />
                        </div>
                        <div class="bg-white">
